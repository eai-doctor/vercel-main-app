...
import { ChatboxModal, LoginModal } from "@/features/modal";
import { ProfileDropdown } from "@/components";
import { AiIcon, MicrophoneIcon, ClipboardIcon, LightbulbIcon, MailIcon, CheckCircleIcon, XCircleIcon, ClockIcon, UserIcon } from './components/icons';
...
export default function PatientPortal() {
  ...
  useEffect(() => {
    ...
    const fetchSymptoms = async () => {
      ...
      try {
        const response = await axios.get(`${API_URL}/api/consultation-summaries/symptoms`);
  ...
  const handleLabReportUpload = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${config.chatboxServiceUrl}/api/lab-report/upload`,
        formData,
