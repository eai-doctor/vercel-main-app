              ...
              <div className="p-4 space-y-3">
                ...
                {consulting && (
                  <div className="flex items-center gap-2 px-3 py-2 bg-red-50 border border-red-200 rounded-xl">
                    ...
                    <span className="text-[12px] font-semibold text-red-700">{t('consultation.listening', 'Recording in progress...')}</span>
                  </div>
                )}
                ...
                {transcriptHistory && !consulting && (
                  <div className="flex-row gap-2 space-y-2">
                    ...
                    <div className="flex items-center gap-2 px-3 py-2 bg-green-50 border border-green-200 rounded-xl">
                      <div className="w-2 h-2 bg-gree-500 rounded-full animate-pulse shrink-0" />
                      <span className="text-[12px] font-semibold">{t('consultation.listeningFinished', 'Recording completed')}</span>
                    </div>
                      ...
                      {previousSymptoms.map((symptom, idx) => {
                        ...
                        return (
                          <li key={idx} className="flex items-center gap-2 bg-slate-50 border border-slate-100 rounded-xl px-3 py-2">
                            ...
                            {symptom.first_mentioned && <span className="text-[10px] text-slate-400">{new Date(symptom.first_mentioned).toLocaleDateString()}</span>}
                          </li>
                        );
                      })}
                    </ul>
