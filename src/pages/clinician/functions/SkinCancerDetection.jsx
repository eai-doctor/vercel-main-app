        ...
        <main className="space-y-6">
          ...
          {result && !loading && (
            <section className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div className="bg-[#1e293b]/70 border border-[#334155] rounded-xl p-5 shadow-inner">
                <div className="flex flex-wrap items-baseline gap-x-4 gap-y-2 mb-3">
                  <span className="text-sm text-[#94a3b8]">Probability of Abnormality</span>
                  ...
                  <span className={`text-xs font-bold px-2.5 py-1 rounded-md
                    ...
                    {result.cancer_positive ? 'Clinical Review Recommended' : 'No Immediate Concern'}
                  </span>
                </div>
                <p className="text-xs text-[#64748b] leading-normal pt-3 border-t border-[#334155]">
                  Note: This result is generated by an automated system. Please consult a healthcare professional for a formal evaluation.
                </p>
              </div>
            </section>
          )}
