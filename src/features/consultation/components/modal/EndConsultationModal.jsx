...
import { endConsultation } from "@/services/consultationService";
...
export default function EndConsultationModal ({
  ...
  const [isSendingEmail, setIsSendingEmail] = useState(false);
    ...
    try {
        ...
        const data = await endConsultation(patientEmail, aiSummary, patient_identification);
        setEmailResult(data);
          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-t-2xl">
              ...
              <p className="text-blue-100 text-center text-sm mt-2">
                {t('clinic:consultation.aiPoweredBy', { model: modelInfo?.model || 'Ollama gemma3:4b', defaultValue: 'AI-generated summary powered by {{model}}' })}
              </p>
            </div>
