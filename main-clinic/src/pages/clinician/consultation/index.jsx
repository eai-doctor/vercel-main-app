    ...
    if (location.state?.patientData) {
      ...
      if (mrn) {
        try {
          ...
          if (fhirRecords) {
            setPatientData(fhirRecordsToPatientData(fhirRecords));
          }
        } catch (error) {
          // Patient details already came from getPatientDetails. FHIR is an
          // optional enrichment and must not make Consultation unusable.
          console.warn("FHIR enrichment unavailable; using patient details", {
