...
// Keep browser requests same-origin. Vite, Vercel, and nginx proxy this path to
// the selected chat service, avoiding service-specific CORS restrictions.
const api = createApi("/api/chat-service");
