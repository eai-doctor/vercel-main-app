import { PORTAL_ROLE, PORTAL_HOME } from "@/app/portal";
...
import LoginModal from "@/pages/public/modal/LoginModal.jsx";
...
function AppLayoutInner() {
  ...
  const handleLoginSuccess = (userData) => {
    onSuccess?.(userData);
    if (PORTAL_ROLE === "clinician") navigate(PORTAL_HOME);
    closeLogin();
  };
